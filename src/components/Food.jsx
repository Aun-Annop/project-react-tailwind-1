            ...
            <div className='flex flex-col lg:flex-row justify-between'>
                 ...
                 <div >
                    ...
                    <div className='flex justify-between flex-wrap'>
                        ...
                        <button onClick={() => filterType('Strawberry')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>Strawberry</button>
                        <button onClick={() => filterType('Green tea')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>Green tea</button>
                        <button onClick={() => filterType('Mango')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>Mango</button>
                    </div>
                 </div>
...
{/* display foods */}
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-4 ">
                {foods.map((item, index)=> (
                    <div key={index} className="border shadow-lg rouded-lg hover:scale-105 duration-300"> 
